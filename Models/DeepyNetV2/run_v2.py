...
from deepynet_v2 import DeepyNetV2
...
run_dir = os.path.join("DeepyNetV2_results", f"seed_{args.seed}_{timestamp}")
...
model = DeepyNetV2(in_channels=in_channels, tabular_dim=tabular_dim, dropout=DROPOUT).to(DEVICE)
